...
List<DropdownMenuItem<String>> get kelasItems {
  List<DropdownMenuItem<String>> menuItems = [
    const DropdownMenuItem(value: "I", child: Text("A")),
    const DropdownMenuItem(value: "II", child: Text("B")),
    const DropdownMenuItem(value: "III", child: Text("C")),
  ];
  return menuItems;
}
...
List<DropdownMenuItem<String>> get jurusanItems {
  List<DropdownMenuItem<String>> menuItems = [
    const DropdownMenuItem(
        value: "OTKP", child: Text("TEKNOLOGI INFORMASI")),
    const DropdownMenuItem(
        value: "TKJ", child: Text("SISTEM INFORMASI")),
    const DropdownMenuItem(value: "TB", child: Text("TEKNIK KOMPUTER")),
    const DropdownMenuItem(value: "TSM", child: Text("TEKNIK ELEKTRO")),
    const DropdownMenuItem(
        value: "RPL", child: Text("TEKNIK INFORMATIKA")),
  ];
  return menuItems;
}
